/*******GUI.java*******
 *****This class identifies, declares, and controls all
 *GUI functions for the GAMPRO program. It contains
 *methods to create Modal and Nonmodal dialogues and
 *JInternmalFrames, which are the driving windows of the
 *program.*************/
